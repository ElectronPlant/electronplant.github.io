...
description: David Arnaiz, an embedded firmware engineer specializing in adaptive IoT sensors, RTOSs, and dynamic energy management for low-power systems. Based in Spain.
---
